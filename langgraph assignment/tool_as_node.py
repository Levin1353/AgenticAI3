...
print("You can chat with the LLM. It will also help you find credly badges for public profiles. It will decide when to use tools (weather, add, subtract). Type 'exit' to quit.")
conversation = []
while True:
